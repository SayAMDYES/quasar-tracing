...
/**
 * One point on the per-service metrics time series.
 *
 * @author Quasar
 * @version 1.0.0
 * @since 2026/06/08
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "A metrics time-series point")
public class MetricPointDTO implements Serializable {
    ...
    @Schema(description = "Error rate as a percent (0..100), plotted directly by the chart")
